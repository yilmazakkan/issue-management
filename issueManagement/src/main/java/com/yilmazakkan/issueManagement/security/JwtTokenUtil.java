package com.yilmazakkan.issueManagement.security;
...
public class JwtTokenUtil {
	...
	public static final String SIGNING_KEY = "yilmaz";
	...
	private String doGenerateToken(String subject) {
		...
		return Jwts.builder().setClaims(claims).setIssuer("http://yilmaz.com")
